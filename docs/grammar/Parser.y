...
STATEMENT : FUNC_CALL LINE_END
          ...
          | RETURN OR_TEST LINE_END
          ;

ASSIGN_STATEMENT : ID ASSIGNMENT OR_TEST
                 | ID ARRAY ASSIGNMENT OR_TEST
...
SIMPLE_TERM : LEFT_PAREN OR_TEST RIGHT_PAREN
            | ID
            | ID ARRAY
            | INTEGER_VALUE
            | BOOL_VALUE
...
CALL_ARGS_LIST : OR_TEST
               | OR_TEST COMMA CALL_ARGS_LIST
               ;
